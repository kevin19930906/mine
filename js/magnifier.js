;(function ($, window, document, undefined) {
  ...
  var Magnifier = function (elem) {
    var self = this;
    this.$elem = elem;
    this.$smallBox = this.$elem.find('.middleArea');
    this.$smallBox_pic = this.$smallBox.find('img');
    this.$smallBox_mask = this.$smallBox.find('.zoom');
    ...
    this.$thumbnailBox_wrapper = this.$thumbnailBox.find('.minArea');
    this.$thumbnailBox_item = this.$thumbnailBox.find('li');
    this.$thumbnailBox_pic = this.$thumbnailBox.find('img');
    this.$bigBox = this.$elem.find('.bigArea');
